...
```elixir
files = ["./02_01_task.md", "./02_02_agent.md", "./02_03_create_gen_server.md"]
...
```elixir-iex
$ iex lib/map_reduce_task.exs
Erlang/OTP 27 [erts-15.2.7.8] [source] [64-bit] [smp:6:6] [ds:6:6:10] [async-threads:1] [jit:ns]

Interactive Elixir (1.19.5) - press Ctrl+C to exit (type h() ENTER for help)
iex(1)> MapReduce.start()
do_reduce [reducer: [mapper: "./02_01_task.md", mapper: "./02_02_agent.md"], reducer: [mapper: "./02_03_create_gen_server.md", mapper: "./02_04_gen_server_module.md"]]
do_reduce [mapper: "./02_01_task.md", mapper: "./02_02_agent.md"]
do_reduce [mapper: "./02_03_create_gen_server.md", mapper: "./02_04_gen_server_module.md"]
do_map file './02_01_task.md'
do_map file './02_02_agent.md'
do_map file './02_03_create_gen_server.md'
do_map file './02_04_gen_server_module.md'
mapper result 783
mapper result 720
mapper result 2090
mapper result 1717
